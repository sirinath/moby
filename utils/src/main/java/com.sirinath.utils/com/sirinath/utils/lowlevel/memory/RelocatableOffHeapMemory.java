...
public final class RelocatableOffHeapMemory extends OffHeapMemory {
    public RelocatableOffHeapMemory(final long bytes) {
        super(bytes);
    }

    private volatile long updating = 0;
    private static final long updatingOffset = Fields.Offset.$(RelocatableOffHeapMemory.class, "updating");
