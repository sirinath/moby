...
public final class Binary64FloatingPointUtils {
    ...
    public static final class BitMasks {
        ...
        public static final long exponentMask = ((Integer64Utils.Constants.one << exponentBits) - Integer64Utils.Constants.one) << significandBits;
        public static final long significandMask = (Integer64Utils.Constants.one << significandBits) - Integer64Utils.Constants.one;
    ...
    public static final class NoneFinite {
        ...
        private static boolean isSignallingNaN(final long value, final long payload) {
            return ((value & quiteNaNMask) == exponentMask) && (extractNaNPayload(value) == payload) && (payload != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isPositiveSignallingNaN(final long value) {
            return ((value & signedQuiteNaNMask) == exponentMask) && (extractNaNPayload(value) != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isPositiveSignallingNaN(final long value, final long payload) {
            return ((value & signedQuiteNaNMask) == exponentMask) && (extractNaNPayload(value) == payload) && (payload != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isNegativeSignallingNaN(final long value) {
            return ((value & signedQuiteNaNMask) == signedExponentMask) && (extractNaNPayload(value) != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isNegativeSignallingNaN(final long value, final long payload) {
            return ((value & signedQuiteNaNMask) == signedExponentMask) && (extractNaNPayload(value) == payload) && (payload != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isNaN(final long value) {
            return ((value & exponentMask) == exponentMask) && (extractSignificand(value) != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isNaN(final long value, final long payload) {
            return ((value & exponentMask) == exponentMask) && (extractSignificand(value) != Integer64Utils.Constants.zero) && (extractNaNPayload(value) == payload);
        }
        ...
        private static boolean isPositiveNaN(final long value) {
            return ((value & signedExponentMask) == exponentMask) && (extractSignificand(value) != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isPositiveNaN(final long value, final long payload) {
            return ((value & signedExponentMask) == exponentMask) && (extractSignificand(value) != Integer64Utils.Constants.zero) && (extractNaNPayload(value) == payload);
        }
        ...
        private static boolean isNegativeNaN(final long value) {
            return ((value & signedExponentMask) == signedExponentMask) && (extractSignificand(value) != Integer64Utils.Constants.zero);
        }
        ...
        private static boolean isNegativeNaN(final long value, final long payload) {
            return ((value & signedExponentMask) == signedExponentMask) && (extractSignificand(value) != Integer64Utils.Constants.zero) && (extractNaNPayload(value) == payload);
        }
